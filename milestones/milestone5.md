...
🔗 <img src='/public/FinalDemo.gif' title='Search Screenshot' width='' alt='Final Demo Screenshot' />

## Reflection

### 1. What went well during this unit?

We as able to complete the project despite having to do a complete rewrite 2 weeks after the project started

### 2. What were some challenges your group faced in this unit?

Our database schema was not the best and we had to change it a few times. We also had some issues with the backend and frontend communicating with each other.

### 3. What were some of the highlights or achievements that you are most proud of in this project?

that we was sucessful in making the realtime chat work and the user can see the chat in realtime.

### 4. Reflecting on your web development journey so far, how have you grown since the beginning of the course?

I have learned a lot about backend and frontend development. I have also learned how to use react and express.

### 5. Looking ahead, what are your goals related to web development, and what steps do you plan to take to achieve them?

I want to build a major app one day and I plan to keep learning and practicing to achieve that goal.
